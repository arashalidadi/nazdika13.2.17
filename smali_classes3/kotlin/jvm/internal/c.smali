...
.field private transient reflected:Ldv/b;
...
.method public varargs call([Ljava/lang/Object;)Ljava/lang/Object;
    ...
    invoke-virtual {p0}, Lkotlin/jvm/internal/c;->getReflected()Ldv/b;

    move-result-object v0

    invoke-interface {v0, p1}, Ldv/b;->call([Ljava/lang/Object;)Ljava/lang/Object;
...
.method public callBy(Ljava/util/Map;)Ljava/lang/Object;
    ...
    invoke-interface {v0, p1}, Ldv/b;->callBy(Ljava/util/Map;)Ljava/lang/Object;
...
.method public compute()Ldv/b;
    .locals 1

    iget-object v0, p0, Lkotlin/jvm/internal/c;->reflected:Ldv/b;

    if-nez v0, :cond_0

    invoke-virtual {p0}, Lkotlin/jvm/internal/c;->computeReflected()Ldv/b;

    move-result-object v0

    iput-object v0, p0, Lkotlin/jvm/internal/c;->reflected:Ldv/b;

    :cond_0
    return-object v0
.end method

.method protected abstract computeReflected()Ldv/b;
.end method
...
.method public getAnnotations()Ljava/util/List;
    ...
    invoke-interface {v0}, Ldv/a;->getAnnotations()Ljava/util/List;
...
.method public getOwner()Ldv/d;
    ...
    invoke-static {v0}, Lkotlin/jvm/internal/g0;->c(Ljava/lang/Class;)Ldv/d;
...
.method public getParameters()Ljava/util/List;
    ...
    invoke-interface {v0}, Ldv/b;->getParameters()Ljava/util/List;
...
.method protected getReflected()Ldv/b;
    .locals 1

    invoke-virtual {p0}, Lkotlin/jvm/internal/c;->compute()Ldv/b;
...
.method public getReturnType()Ldv/k;
    .locals 1
    ...
    invoke-interface {v0}, Ldv/b;->getReturnType()Ldv/k;
...
.method public getTypeParameters()Ljava/util/List;
    ...
    invoke-interface {v0}, Ldv/b;->getTypeParameters()Ljava/util/List;
...
.method public getVisibility()Ldv/l;
    .locals 1
    ...
    invoke-interface {v0}, Ldv/b;->getVisibility()Ldv/l;
...
.method public isAbstract()Z
    ...
    invoke-interface {v0}, Ldv/b;->isAbstract()Z
...
.method public isFinal()Z
    ...
    invoke-interface {v0}, Ldv/b;->isFinal()Z
...
.method public isOpen()Z
    ...
    invoke-interface {v0}, Ldv/b;->isOpen()Z
...
.method public isSuspend()Z
    ...
    invoke-interface {v0}, Ldv/b;->isSuspend()Z
