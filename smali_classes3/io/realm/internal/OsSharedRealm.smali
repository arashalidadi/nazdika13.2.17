...
.method constructor <init>(JLio/realm/internal/OsRealmConfig;)V
    ...
    invoke-virtual {p3}, Lio/realm/internal/OsRealmConfig;->a()Lio/realm/internal/h;
...
.method constructor <init>(JLio/realm/internal/OsRealmConfig;Lio/realm/internal/h;)V
    .locals 2
...
.method private constructor <init>(Lio/realm/internal/OsRealmConfig;Lio/realm/internal/OsSharedRealm$a;)V
    ...
    invoke-virtual {p1}, Lio/realm/internal/OsRealmConfig;->a()Lio/realm/internal/h;
    ...
    iget-wide v4, p2, Lio/realm/internal/OsSharedRealm$a;->d:J

    iget-wide v6, p2, Lio/realm/internal/OsSharedRealm$a;->e:J
...
.method private executePendingRowQueries()V
    ...
    invoke-virtual {v1}, Lio/realm/internal/m;->e()V
...
.method public static getInstance(Lio/realm/internal/OsRealmConfig$b;Lio/realm/internal/OsSharedRealm$a;)Lio/realm/internal/OsSharedRealm;
    ...
    invoke-virtual {v0, p0}, Lio/realm/internal/j;->j(Lio/realm/internal/OsRealmConfig;)V
...
.method public static getInstance(Lio/realm/k2;Lio/realm/internal/OsSharedRealm$a;)Lio/realm/internal/OsSharedRealm;
    .locals 1

    new-instance v0, Lio/realm/internal/OsRealmConfig$b;

    invoke-direct {v0, p0}, Lio/realm/internal/OsRealmConfig$b;-><init>(Lio/realm/k2;)V
...
.method private static runMigrationCallback(JLio/realm/internal/OsRealmConfig;Lio/realm/internal/OsSharedRealm$MigrationCallback;J)V
    ...
    invoke-virtual {p2}, Lio/realm/internal/OsRealmConfig;->b()Lio/realm/k2;

    move-result-object p0

    invoke-virtual {p0}, Lio/realm/k2;->p()J
...
.method addPendingRow(Lio/realm/internal/m;)V
    .locals 2
...
.method public getConfiguration()Lio/realm/k2;
    .locals 1

    iget-object v0, p0, Lio/realm/internal/OsSharedRealm;->osRealmConfig:Lio/realm/internal/OsRealmConfig;

    invoke-virtual {v0}, Lio/realm/internal/OsRealmConfig;->b()Lio/realm/k2;
...
.method invalidateIterators()V
    ...
    invoke-virtual {v1}, Lio/realm/internal/OsResults$a;->g()V
...
.method removePendingRow(Lio/realm/internal/m;)V
    .locals 3
