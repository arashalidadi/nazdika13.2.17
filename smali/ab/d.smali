...
# direct methods
.method public constructor <init>(Landroid/content/Context;Lbb/d;Lab/f;)V
    .locals 0
    ...
    iput-object p2, p0, Lab/d;->b:Lbb/d;

    iput-object p3, p0, Lab/d;->c:Lab/f;
...
# virtual methods
.method public a(Lta/p;I)V
    .locals 1

    const/4 v0, 0x0

    invoke-virtual {p0, p1, p2, v0}, Lab/d;->b(Lta/p;IZ)V

    return-void
.end method

.method public b(Lta/p;IZ)V
    .locals 12
    ...
    invoke-virtual {p0, p1}, Lab/d;->c(Lta/p;)I
    ...
    invoke-direct {p0, v1, v2, p2}, Lab/d;->d(Landroid/app/job/JobScheduler;II)Z
    ...
    invoke-static {v3, p2, p1}, Lxa/a;->b(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Object;)V

    return-void

    :cond_0
    iget-object p3, p0, Lab/d;->b:Lbb/d;

    invoke-interface {p3, p1}, Lbb/d;->a1(Lta/p;)J

    move-result-wide v10

    iget-object v4, p0, Lab/d;->c:Lab/f;
    ...
    invoke-virtual/range {v4 .. v9}, Lab/f;->c(Landroid/app/job/JobInfo$Builder;Lra/d;JI)Landroid/app/job/JobInfo$Builder;
    ...
    invoke-static {v4}, Leb/a;->a(Lra/d;)I
    ...
    iget-object v2, p0, Lab/d;->c:Lab/f;

    invoke-virtual {p1}, Lta/p;->d()Lra/d;

    move-result-object p1

    invoke-virtual {v2, p1, v10, v11, p2}, Lab/f;->g(Lra/d;JI)J
    ...
    invoke-static {v3, p1, v0}, Lxa/a;->c(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V
...
.method c(Lta/p;)I
    ...
    invoke-static {v2}, Leb/a;->a(Lra/d;)I
