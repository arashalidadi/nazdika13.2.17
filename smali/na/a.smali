...
.method private d(Landroid/content/Context;[Ljava/lang/String;Ljava/lang/String;Lna/d;)Lna/a$a;
    .locals 16

    move-object/from16 v0, p2

    invoke-direct/range {p0 .. p1}, Lna/a;->f(Landroid/content/Context;)[Ljava/lang/String;
    ...
    invoke-virtual {v3, v15, v14}, Lna/d;->i(Ljava/lang/String;[Ljava/lang/Object;)V
    ...
    invoke-direct {v0, v5, v13}, Lna/a$a;-><init>(Ljava/util/zip/ZipFile;Ljava/util/zip/ZipEntry;)V
...
.method private e(Landroid/content/Context;Ljava/lang/String;)[Ljava/lang/String;
    ...
    invoke-direct {p0, p1}, Lna/a;->f(Landroid/content/Context;)[Ljava/lang/String;
...
# virtual methods
.method public a(Landroid/content/Context;[Ljava/lang/String;Ljava/lang/String;Ljava/io/File;Lna/d;)V
    .locals 10

    const/4 v0, 0x0

    :try_start_0
    invoke-direct {p0, p1, p2, p3, p5}, Lna/a;->d(Landroid/content/Context;[Ljava/lang/String;Ljava/lang/String;Lna/d;)Lna/a$a;
    ...
    invoke-virtual {p5, p1, v4}, Lna/d;->i(Ljava/lang/String;[Ljava/lang/Object;)V
    :try_end_1
    ...
    :cond_0
    :try_start_3
    iget-object p1, v1, Lna/a$a;->a:Ljava/util/zip/ZipFile;

    iget-object v4, v1, Lna/a$a;->b:Ljava/util/zip/ZipEntry;
    ...
    :try_start_5
    invoke-direct {p0, p1, v4}, Lna/a;->c(Ljava/io/InputStream;Ljava/io/OutputStream;)J
    ...
    :try_start_6
    invoke-direct {p0, p1}, Lna/a;->b(Ljava/io/Closeable;)V

    :goto_1
    invoke-direct {p0, v4}, Lna/a;->b(Ljava/io/Closeable;)V
    ...
    :goto_3
    :try_start_8
    invoke-direct {p0, v0}, Lna/a;->b(Ljava/io/Closeable;)V
    ...
    invoke-virtual {p5, p1}, Lna/d;->h(Ljava/lang/String;)V
    :try_end_8
    ...
    :cond_5
    :try_start_a
    invoke-direct {p0, p1, p3}, Lna/a;->e(Landroid/content/Context;Ljava/lang/String;)[Ljava/lang/String;
    ...
    invoke-direct {p4, p3, p2, p1}, Lna/b;-><init>(Ljava/lang/String;[Ljava/lang/String;[Ljava/lang/String;)V
    ...
    :try_start_c
    iget-object p2, v0, Lna/a$a;->a:Ljava/util/zip/ZipFile;
