...
.method private d(Landroid/net/Uri;Ljava/lang/String;)Landroid/content/Context;
    ...
    iget-object v0, p0, Lb6/k;->a:Landroid/content/Context;
    ...
    iget-object p1, p0, Lb6/k;->a:Landroid/content/Context;
    ...
    iget-object v1, p0, Lb6/k;->a:Landroid/content/Context;
...
.method private g(Landroid/content/Context;Landroid/net/Uri;)I
    ...
    invoke-direct {p0, p1, p2}, Lb6/k;->f(Landroid/content/Context;Landroid/net/Uri;)I
    ...
    invoke-direct {p0, p2}, Lb6/k;->e(Landroid/net/Uri;)I
...
.method public bridge synthetic a(Ljava/lang/Object;Lq5/i;)Z
    ...
    invoke-virtual {p0, p1, p2}, Lb6/k;->h(Landroid/net/Uri;Lq5/i;)Z
...
.method public bridge synthetic b(Ljava/lang/Object;IILq5/i;)Ls5/v;
    ...
    invoke-virtual {p0, p1, p2, p3, p4}, Lb6/k;->c(Landroid/net/Uri;IILq5/i;)Ls5/v;
...
.method public c(Landroid/net/Uri;IILq5/i;)Ls5/v;
    ...
    invoke-direct {p0, p1, p2}, Lb6/k;->d(Landroid/net/Uri;Ljava/lang/String;)Landroid/content/Context;

    move-result-object p3

    invoke-direct {p0, p3, p1}, Lb6/k;->g(Landroid/content/Context;Landroid/net/Uri;)I
    ...
    iget-object p2, p0, Lb6/k;->a:Landroid/content/Context;

    invoke-static {p2, p3, p1}, Lb6/g;->b(Landroid/content/Context;Landroid/content/Context;I)Landroid/graphics/drawable/Drawable;
    ...
    :cond_1
    iget-object p3, p0, Lb6/k;->a:Landroid/content/Context;

    invoke-static {p3, p1, p2}, Lb6/g;->a(Landroid/content/Context;ILandroid/content/res/Resources$Theme;)Landroid/graphics/drawable/Drawable;
...
.method public h(Landroid/net/Uri;Lq5/i;)Z
    .locals 0
