...
# static fields
.field private static final a:Landroidx/core/graphics/h0;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Landroidx/core/graphics/j;->a:Landroidx/core/graphics/h0;
    ...
    sput-object v0, Landroidx/core/graphics/j;->b:Lp/e;
...
.method public static b(Landroid/content/Context;Landroid/os/CancellationSignal;[Landroidx/core/provider/g$b;I)Landroid/graphics/Typeface;
    ...
    sget-object v0, Landroidx/core/graphics/j;->a:Landroidx/core/graphics/h0;

    invoke-virtual {v0, p0, p1, p2, p3}, Landroidx/core/graphics/h0;->b(Landroid/content/Context;Landroid/os/CancellationSignal;[Landroidx/core/provider/g$b;I)Landroid/graphics/Typeface;
...
.method public static c(Landroid/content/Context;Landroidx/core/content/res/e$b;Landroid/content/res/Resources;ILjava/lang/String;IILandroidx/core/content/res/h$e;Landroid/os/Handler;Z)Landroid/graphics/Typeface;
    ...
    invoke-static {v3}, Landroidx/core/graphics/j;->g(Ljava/lang/String;)Landroid/graphics/Typeface;
    ...
    new-instance v12, Landroidx/core/graphics/j$a;

    invoke-direct {v12, v1}, Landroidx/core/graphics/j$a;-><init>(Landroidx/core/content/res/h$e;)V
    ...
    :cond_5
    sget-object v3, Landroidx/core/graphics/j;->a:Landroidx/core/graphics/h0;
    ...
    invoke-virtual {v3, p0, v0, p2, v6}, Landroidx/core/graphics/h0;->a(Landroid/content/Context;Landroidx/core/content/res/e$c;Landroid/content/res/Resources;I)Landroid/graphics/Typeface;
    ...
    sget-object v1, Landroidx/core/graphics/j;->b:Lp/e;
...
.method public static d(Landroid/content/Context;Landroid/content/res/Resources;ILjava/lang/String;II)Landroid/graphics/Typeface;
    ...
    invoke-virtual/range {v0 .. v5}, Landroidx/core/graphics/h0;->d(Landroid/content/Context;Landroid/content/res/Resources;ILjava/lang/String;I)Landroid/graphics/Typeface;

    move-result-object p0

    if-eqz p0, :cond_0

    invoke-static {p1, p2, p3, p4, p5}, Landroidx/core/graphics/j;->e(Landroid/content/res/Resources;ILjava/lang/String;II)Ljava/lang/String;

    move-result-object p1

    sget-object p2, Landroidx/core/graphics/j;->b:Lp/e;
...
.method public static f(Landroid/content/res/Resources;ILjava/lang/String;II)Landroid/graphics/Typeface;
    ...
    sget-object v0, Landroidx/core/graphics/j;->b:Lp/e;

    invoke-static {p0, p1, p2, p3, p4}, Landroidx/core/graphics/j;->e(Landroid/content/res/Resources;ILjava/lang/String;II)Ljava/lang/String;
