...
.method constructor <init>(Landroidx/core/view/j3;Landroid/view/WindowInsets;)V
    ...
    iput-object p1, p0, Landroidx/core/view/j3$g;->e:Landroidx/core/graphics/f;
...
.method private u(IZ)Landroidx/core/graphics/f;
    .locals 3
    ...
    :cond_0
    invoke-virtual {p0, v1, p2}, Landroidx/core/view/j3$g;->v(IZ)Landroidx/core/graphics/f;
...
.method private w()Landroidx/core/graphics/f;
    .locals 1
    ...
    invoke-virtual {v0}, Landroidx/core/view/j3;->g()Landroidx/core/graphics/f;
...
.method private x(Landroid/view/View;)Landroidx/core/graphics/f;
    .locals 4
    ...
    sget-boolean v1, Landroidx/core/view/j3$g;->h:Z

    if-nez v1, :cond_0

    invoke-static {}, Landroidx/core/view/j3$g;->z()V

    :cond_0
    sget-object v1, Landroidx/core/view/j3$g;->i:Ljava/lang/reflect/Method;

    const/4 v2, 0x0

    if-eqz v1, :cond_4

    sget-object v3, Landroidx/core/view/j3$g;->j:Ljava/lang/Class;

    if-eqz v3, :cond_4

    sget-object v3, Landroidx/core/view/j3$g;->k:Ljava/lang/reflect/Field;
...
.method d(Landroid/view/View;)V
    ...
    invoke-direct {p0, p1}, Landroidx/core/view/j3$g;->x(Landroid/view/View;)Landroidx/core/graphics/f;
    ...
    :cond_0
    invoke-virtual {p0, p1}, Landroidx/core/view/j3$g;->r(Landroidx/core/graphics/f;)V
...
.method e(Landroidx/core/view/j3;)V
    ...
    invoke-virtual {p1, v0}, Landroidx/core/view/j3;->s(Landroidx/core/view/j3;)V

    iget-object v0, p0, Landroidx/core/view/j3$g;->g:Landroidx/core/graphics/f;

    invoke-virtual {p1, v0}, Landroidx/core/view/j3;->r(Landroidx/core/graphics/f;)V
...
.method public equals(Ljava/lang/Object;)Z
    ...
    iget-object p1, p1, Landroidx/core/view/j3$g;->g:Landroidx/core/graphics/f;
...
.method public g(I)Landroidx/core/graphics/f;
    ...
    invoke-direct {p0, p1, v0}, Landroidx/core/view/j3$g;->u(IZ)Landroidx/core/graphics/f;
...
.method final k()Landroidx/core/graphics/f;
    ...
    iget-object v0, p0, Landroidx/core/view/j3$g;->e:Landroidx/core/graphics/f;
    ...
    iput-object v0, p0, Landroidx/core/view/j3$g;->e:Landroidx/core/graphics/f;
...
.method m(IIII)Landroidx/core/view/j3;
    ...
    invoke-static {v1}, Landroidx/core/view/j3;->v(Landroid/view/WindowInsets;)Landroidx/core/view/j3;

    move-result-object v1

    invoke-direct {v0, v1}, Landroidx/core/view/j3$b;-><init>(Landroidx/core/view/j3;)V

    invoke-virtual {p0}, Landroidx/core/view/j3$g;->k()Landroidx/core/graphics/f;

    move-result-object v1

    invoke-static {v1, p1, p2, p3, p4}, Landroidx/core/view/j3;->m(Landroidx/core/graphics/f;IIII)Landroidx/core/graphics/f;

    move-result-object v1

    invoke-virtual {v0, v1}, Landroidx/core/view/j3$b;->c(Landroidx/core/graphics/f;)Landroidx/core/view/j3$b;
    ...
    invoke-virtual {v0, p1}, Landroidx/core/view/j3$b;->b(Landroidx/core/graphics/f;)Landroidx/core/view/j3$b;
...
.method p(I)Z
    ...
    :cond_0
    invoke-virtual {p0, v1}, Landroidx/core/view/j3$g;->y(I)Z
...
.method public q([Landroidx/core/graphics/f;)V
    ...
    iput-object p1, p0, Landroidx/core/view/j3$g;->d:[Landroidx/core/graphics/f;
...
.method r(Landroidx/core/graphics/f;)V
    ...
    iput-object p1, p0, Landroidx/core/view/j3$g;->g:Landroidx/core/graphics/f;
...
.method protected v(IZ)Landroidx/core/graphics/f;
    .locals 4
    ...
    invoke-virtual {p1}, Landroidx/core/view/j3;->e()Landroidx/core/view/q;
    ...
    :cond_3
    invoke-virtual {p0}, Landroidx/core/view/j3$l;->l()Landroidx/core/graphics/f;
    ...
    :cond_4
    invoke-virtual {p0}, Landroidx/core/view/j3$l;->h()Landroidx/core/graphics/f;
    ...
    :cond_5
    invoke-virtual {p0}, Landroidx/core/view/j3$l;->j()Landroidx/core/graphics/f;
    ...
    :cond_6
    iget-object p1, p0, Landroidx/core/view/j3$g;->d:[Landroidx/core/graphics/f;

    if-eqz p1, :cond_7

    invoke-static {p2}, Landroidx/core/view/j3$m;->b(I)I
    ...
    invoke-direct {p0}, Landroidx/core/view/j3$g;->w()Landroidx/core/graphics/f;
    ...
    :cond_9
    iget-object p1, p0, Landroidx/core/view/j3$g;->g:Landroidx/core/graphics/f;
    ...
    invoke-virtual {p2}, Landroidx/core/view/j3;->g()Landroidx/core/graphics/f;
...
.method protected y(I)Z
    ...
    :cond_1
    invoke-virtual {p0, p1, v0}, Landroidx/core/view/j3$g;->v(IZ)Landroidx/core/graphics/f;
