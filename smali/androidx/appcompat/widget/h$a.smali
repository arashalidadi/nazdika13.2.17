...
# interfaces
.implements Landroidx/appcompat/widget/j2$f;
...
.method private h(Landroid/content/Context;I)Landroid/content/res/ColorStateList;
    ...
    invoke-static {p1, v2}, Landroidx/appcompat/widget/p2;->c(Landroid/content/Context;I)I

    move-result v2

    sget v3, Le/a;->u:I

    invoke-static {p1, v3}, Landroidx/appcompat/widget/p2;->b(Landroid/content/Context;I)I

    move-result p1

    sget-object v3, Landroidx/appcompat/widget/p2;->b:[I
    ...
    sget-object p1, Landroidx/appcompat/widget/p2;->e:[I

    const/4 v3, 0x1

    aput-object p1, v1, v3

    invoke-static {v2, p2}, Landroidx/core/graphics/d;->j(II)I

    move-result p1

    aput p1, v0, v3

    sget-object p1, Landroidx/appcompat/widget/p2;->c:[I
    ...
    sget-object p1, Landroidx/appcompat/widget/p2;->i:[I
...
.method private i(Landroid/content/Context;)Landroid/content/res/ColorStateList;
    ...
    invoke-static {p1, v0}, Landroidx/appcompat/widget/p2;->c(Landroid/content/Context;I)I
...
.method private k(Landroid/content/Context;)Landroid/content/res/ColorStateList;
    ...
    invoke-static {p1, v2}, Landroidx/appcompat/widget/p2;->e(Landroid/content/Context;I)Landroid/content/res/ColorStateList;
    ...
    sget-object v2, Landroidx/appcompat/widget/p2;->b:[I
    ...
    sget-object v2, Landroidx/appcompat/widget/p2;->f:[I
    ...
    invoke-static {p1, v2}, Landroidx/appcompat/widget/p2;->b(Landroid/content/Context;I)I

    move-result v3

    aput v3, v0, v6

    sget-object v3, Landroidx/appcompat/widget/p2;->f:[I

    aput-object v3, v1, v5

    sget v3, Le/a;->v:I

    invoke-static {p1, v3}, Landroidx/appcompat/widget/p2;->c(Landroid/content/Context;I)I

    move-result v3

    aput v3, v0, v5

    sget-object v3, Landroidx/appcompat/widget/p2;->i:[I
...
.method private l(Landroidx/appcompat/widget/j2;Landroid/content/Context;I)Landroid/graphics/drawable/LayerDrawable;
    .locals 4
    ...
    invoke-virtual {p1, p2, v0}, Landroidx/appcompat/widget/j2;->j(Landroid/content/Context;I)Landroid/graphics/drawable/Drawable;

    move-result-object v0

    sget v1, Le/e;->G:I

    invoke-virtual {p1, p2, v1}, Landroidx/appcompat/widget/j2;->j(Landroid/content/Context;I)Landroid/graphics/drawable/Drawable;
...
.method private m(Landroid/graphics/drawable/Drawable;ILandroid/graphics/PorterDuff$Mode;)V
    ...
    invoke-static {p1}, Landroidx/appcompat/widget/u1;->a(Landroid/graphics/drawable/Drawable;)Z
...
.method public a(Landroid/content/Context;ILandroid/graphics/drawable/Drawable;)Z
    ...
    invoke-static {p3}, Landroidx/appcompat/widget/u1;->a(Landroid/graphics/drawable/Drawable;)Z
    ...
    :cond_5
    invoke-static {p1, p2}, Landroidx/appcompat/widget/p2;->c(Landroid/content/Context;I)I
...
.method public c(Landroidx/appcompat/widget/j2;Landroid/content/Context;I)Landroid/graphics/drawable/Drawable;
    .locals 3
    ...
    invoke-direct {p0, p1, p2, p3}, Landroidx/appcompat/widget/h$a;->l(Landroidx/appcompat/widget/j2;Landroid/content/Context;I)Landroid/graphics/drawable/LayerDrawable;
...
.method public d(Landroid/content/Context;I)Landroid/content/res/ColorStateList;
    ...
    invoke-static {p1, p2}, Landroidx/appcompat/widget/p2;->e(Landroid/content/Context;I)Landroid/content/res/ColorStateList;
...
.method public e(Landroid/content/Context;ILandroid/graphics/drawable/Drawable;)Z
    ...
    invoke-direct {p0, p2, v4, v5}, Landroidx/appcompat/widget/h$a;->m(Landroid/graphics/drawable/Drawable;ILandroid/graphics/PorterDuff$Mode;)V
    ...
    invoke-static {p1, p3}, Landroidx/appcompat/widget/p2;->c(Landroid/content/Context;I)I
    ...
    invoke-static {p1, v0}, Landroidx/appcompat/widget/p2;->b(Landroid/content/Context;I)I
    ...
    invoke-direct {p0, p2, v3, v4}, Landroidx/appcompat/widget/h$a;->m(Landroid/graphics/drawable/Drawable;ILandroid/graphics/PorterDuff$Mode;)V
