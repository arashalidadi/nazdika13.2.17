...
.method final f(Landroidx/recyclerview/widget/RecyclerView;Landroidx/recyclerview/widget/RecyclerView$d0;)I
    ...
    invoke-virtual {p0, p1, p2}, Landroidx/recyclerview/widget/k$e;->k(Landroidx/recyclerview/widget/RecyclerView;Landroidx/recyclerview/widget/RecyclerView$d0;)I
...
.method o(Landroidx/recyclerview/widget/RecyclerView;Landroidx/recyclerview/widget/RecyclerView$d0;)Z
    ...
    invoke-virtual {p0, p1, p2}, Landroidx/recyclerview/widget/k$e;->f(Landroidx/recyclerview/widget/RecyclerView;Landroidx/recyclerview/widget/RecyclerView$d0;)I
...
.method w(Landroid/graphics/Canvas;Landroidx/recyclerview/widget/RecyclerView;Landroidx/recyclerview/widget/RecyclerView$d0;Ljava/util/List;IFF)V
    ...
    iget-object v3, v0, Landroidx/recyclerview/widget/k$g;->h:Landroidx/recyclerview/widget/RecyclerView$d0;

    iget v4, v0, Landroidx/recyclerview/widget/k$g;->m:F

    iget v5, v0, Landroidx/recyclerview/widget/k$g;->n:F

    iget v6, v0, Landroidx/recyclerview/widget/k$g;->i:I
    ...
    invoke-virtual/range {v0 .. v7}, Landroidx/recyclerview/widget/k$e;->u(Landroid/graphics/Canvas;Landroidx/recyclerview/widget/RecyclerView;Landroidx/recyclerview/widget/RecyclerView$d0;FFIZ)V
...
.method x(Landroid/graphics/Canvas;Landroidx/recyclerview/widget/RecyclerView;Landroidx/recyclerview/widget/RecyclerView$d0;Ljava/util/List;IFF)V
    ...
    invoke-virtual/range {v0 .. v7}, Landroidx/recyclerview/widget/k$e;->v(Landroid/graphics/Canvas;Landroidx/recyclerview/widget/RecyclerView;Landroidx/recyclerview/widget/RecyclerView$d0;FFIZ)V
    ...
    iget-boolean v2, v1, Landroidx/recyclerview/widget/k$g;->p:Z

    if-eqz v2, :cond_2

    iget-boolean v1, v1, Landroidx/recyclerview/widget/k$g;->l:Z
...
.method public z(Landroidx/recyclerview/widget/RecyclerView;Landroidx/recyclerview/widget/RecyclerView$d0;ILandroidx/recyclerview/widget/RecyclerView$d0;III)V
    ...
    invoke-interface {p3, p1, p2, p6, p7}, Landroidx/recyclerview/widget/k$h;->g(Landroid/view/View;Landroid/view/View;II)V

    return-void

    :cond_0
    invoke-virtual {p3}, Landroidx/recyclerview/widget/RecyclerView$p;->v()Z
    ...
    invoke-virtual {p3, p2}, Landroidx/recyclerview/widget/RecyclerView$p;->e0(Landroid/view/View;)I
    ...
    :cond_2
    invoke-virtual {p3}, Landroidx/recyclerview/widget/RecyclerView$p;->w()Z
    ...
    invoke-virtual {p3, p2}, Landroidx/recyclerview/widget/RecyclerView$p;->f0(Landroid/view/View;)I
