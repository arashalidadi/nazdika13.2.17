...
.annotation system Ldalvik/annotation/MemberClasses;
    value = {
        Lcom/facebook/soloader/m$f;,
        Lcom/facebook/soloader/m$e;,
        Lcom/facebook/soloader/m$d;,
...
.method protected constructor <init>(Landroid/content/Context;Ljava/lang/String;)V
    ...
    invoke-static {p1, p2}, Lcom/facebook/soloader/m;->l(Landroid/content/Context;Ljava/lang/String;)Ljava/io/File;
    ...
    iput-object p2, p0, Lcom/facebook/soloader/m;->f:Ljava/util/Map;

    iput-object p1, p0, Lcom/facebook/soloader/m;->c:Landroid/content/Context;

    return-void
.end method

.method static synthetic f(Ljava/io/File;B)V
    .locals 0
    ...
    invoke-static {p0, p1}, Lcom/facebook/soloader/m;->r(Ljava/io/File;B)V

    return-void
.end method

.method private g([Lcom/facebook/soloader/m$b;)V
    .locals 7
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/io/IOException;
    ...
    iget-object v6, v6, Lcom/facebook/soloader/m$b;->d:Ljava/lang/String;
...
.method private h(Lcom/facebook/soloader/m$d;[B)V
    .locals 6
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/io/IOException;
    ...
    iget-object v3, p1, Lcom/facebook/soloader/m$d;->d:Lcom/facebook/soloader/m$b;

    iget-object v3, v3, Lcom/facebook/soloader/m$b;->d:Ljava/lang/String;
    ...
    invoke-direct {p0, p1, p2}, Lcom/facebook/soloader/m;->i(Lcom/facebook/soloader/m$d;[B)V
    :try_end_0
...
.method private i(Lcom/facebook/soloader/m$d;[B)V
    .locals 11
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/io/IOException;
    ...
    iget-object v6, p1, Lcom/facebook/soloader/m$d;->d:Lcom/facebook/soloader/m$b;
    ...
    :goto_1
    iget-object v0, p1, Lcom/facebook/soloader/m$d;->e:Ljava/io/InputStream;
    ...
    :cond_1
    iget-object p1, p1, Lcom/facebook/soloader/m$d;->e:Ljava/io/InputStream;
...
.method private k(Ljava/lang/String;)Ljava/lang/Object;
    ...
    iget-object v0, p0, Lcom/facebook/soloader/m;->f:Ljava/util/Map;

    monitor-enter v0

    :try_start_0
    iget-object v1, p0, Lcom/facebook/soloader/m;->f:Ljava/util/Map;
    ...
    iget-object v2, p0, Lcom/facebook/soloader/m;->f:Ljava/util/Map;
...
.method private o(Lcom/facebook/soloader/f;I[B)Z
    .locals 11
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/io/IOException;
    ...
    invoke-static {v6, v3}, Lcom/facebook/soloader/m;->r(Ljava/io/File;B)V

    invoke-virtual {p0}, Lcom/facebook/soloader/m;->m()Lcom/facebook/soloader/m$f;
    ...
    :try_start_4
    invoke-virtual {v0}, Lcom/facebook/soloader/m$f;->a()Lcom/facebook/soloader/m$c;

    move-result-object v2

    invoke-virtual {v0}, Lcom/facebook/soloader/m$f;->b()Lcom/facebook/soloader/m$e;
    ...
    :try_start_5
    invoke-direct {p0, v4, v2, v7}, Lcom/facebook/soloader/m;->p(BLcom/facebook/soloader/m$c;Lcom/facebook/soloader/m$e;)V
    :try_end_5
    ...
    :try_start_6
    invoke-virtual {v7}, Lcom/facebook/soloader/m$e;->close()V
    :try_end_6
    .catchall {:try_start_6 .. :try_end_6} :catchall_6

    :cond_5
    :try_start_7
    invoke-virtual {v0}, Lcom/facebook/soloader/m$f;->close()V
    :try_end_7
    ...
    :cond_6
    new-instance v9, Lcom/facebook/soloader/m$a;
    ...
    invoke-direct/range {v1 .. v7}, Lcom/facebook/soloader/m$a;-><init>(Lcom/facebook/soloader/m;Ljava/io/File;[BLcom/facebook/soloader/m$c;Ljava/io/File;Lcom/facebook/soloader/f;)V
...
.method private p(BLcom/facebook/soloader/m$c;Lcom/facebook/soloader/m$e;)V
    .locals 9
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/io/IOException;
    ...
    :try_start_0
    invoke-static {v2}, Lcom/facebook/soloader/m$c;->a(Ljava/io/DataInput;)Lcom/facebook/soloader/m$c;
    ...
    new-instance p1, Lcom/facebook/soloader/m$c;

    new-array v4, v3, [Lcom/facebook/soloader/m$b;

    invoke-direct {p1, v4}, Lcom/facebook/soloader/m$c;-><init>([Lcom/facebook/soloader/m$b;)V

    :cond_1
    iget-object p2, p2, Lcom/facebook/soloader/m$c;->a:[Lcom/facebook/soloader/m$b;

    invoke-direct {p0, p2}, Lcom/facebook/soloader/m;->g([Lcom/facebook/soloader/m$b;)V
    ...
    :cond_2
    :goto_1
    invoke-virtual {p3}, Lcom/facebook/soloader/m$e;->a()Z

    move-result v4

    if-eqz v4, :cond_7

    invoke-virtual {p3}, Lcom/facebook/soloader/m$e;->b()Lcom/facebook/soloader/m$d;
    ...
    :try_start_2
    iget-object v7, p1, Lcom/facebook/soloader/m$c;->a:[Lcom/facebook/soloader/m$b;
    ...
    iget-object v7, v7, Lcom/facebook/soloader/m$b;->d:Ljava/lang/String;

    iget-object v8, v4, Lcom/facebook/soloader/m$d;->d:Lcom/facebook/soloader/m$b;

    iget-object v8, v8, Lcom/facebook/soloader/m$b;->d:Ljava/lang/String;
    ...
    iget-object v7, v7, Lcom/facebook/soloader/m$b;->e:Ljava/lang/String;

    iget-object v8, v4, Lcom/facebook/soloader/m$d;->d:Lcom/facebook/soloader/m$b;

    iget-object v8, v8, Lcom/facebook/soloader/m$b;->e:Ljava/lang/String;
    ...
    invoke-direct {p0, v4, p2}, Lcom/facebook/soloader/m;->h(Lcom/facebook/soloader/m$d;[B)V
    :try_end_2
    ...
    :try_start_4
    invoke-virtual {v4}, Lcom/facebook/soloader/m$d;->close()V
    :try_end_4
...
.method public a(Ljava/lang/String;ILandroid/os/StrictMode$ThreadPolicy;)I
    ...
    invoke-direct {p0, p1}, Lcom/facebook/soloader/m;->k(Ljava/lang/String;)Ljava/lang/Object;
...
.method protected b(I)V
    ...
    invoke-static {v4}, Lcom/facebook/soloader/f;->a(Ljava/io/File;)Lcom/facebook/soloader/f;
    ...
    invoke-virtual {p0}, Lcom/facebook/soloader/m;->j()[B

    move-result-object v5

    invoke-direct {p0, v4, p1, v5}, Lcom/facebook/soloader/m;->o(Lcom/facebook/soloader/f;I[B)Z
    ...
    invoke-virtual {v4}, Lcom/facebook/soloader/f;->close()V
...
.method protected j()[B
    ...
    :try_start_0
    invoke-virtual {v1}, Lcom/facebook/soloader/m$f;->a()Lcom/facebook/soloader/m$c;

    move-result-object v2

    iget-object v2, v2, Lcom/facebook/soloader/m$c;->a:[Lcom/facebook/soloader/m$b;
    ...
    iget-object v4, v4, Lcom/facebook/soloader/m$b;->e:Ljava/lang/String;
    ...
    :cond_0
    invoke-virtual {v1}, Lcom/facebook/soloader/m$f;->close()V
...
.method protected abstract m()Lcom/facebook/soloader/m$f;
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/io/IOException;
        }
...
.method protected declared-synchronized n(Ljava/lang/String;)V
    ...
    :try_start_1
    iput-object p1, p0, Lcom/facebook/soloader/m;->d:Ljava/lang/String;

    const/4 p1, 0x2

    invoke-virtual {p0, p1}, Lcom/facebook/soloader/m;->b(I)V
...
.method public q([Ljava/lang/String;)V
    ...
    iput-object p1, p0, Lcom/facebook/soloader/m;->e:[Ljava/lang/String;
