.class public abstract Lso/x;
.super Landroidx/fragment/app/Fragment;
.source "Hilt_CreatePageFinishFragment.java"
...
.method constructor <init>(I)V
    ...
    iput-object p1, p0, Lso/x;->H:Ljava/lang/Object;

    const/4 p1, 0x0

    iput-boolean p1, p0, Lso/x;->I:Z
...
.method private m0()V
    ...
    iget-object v0, p0, Lso/x;->E:Landroid/content/ContextWrapper;
    ...
    iput-object v0, p0, Lso/x;->E:Landroid/content/ContextWrapper;
...
.method public final k0()Ldagger/hilt/android/internal/managers/f;
    ...
    iget-object v0, p0, Lso/x;->G:Ldagger/hilt/android/internal/managers/f;

    if-nez v0, :cond_1

    iget-object v0, p0, Lso/x;->H:Ljava/lang/Object;

    monitor-enter v0

    :try_start_0
    iget-object v1, p0, Lso/x;->G:Ldagger/hilt/android/internal/managers/f;

    if-nez v1, :cond_0

    invoke-virtual {p0}, Lso/x;->l0()Ldagger/hilt/android/internal/managers/f;

    move-result-object v1

    iput-object v1, p0, Lso/x;->G:Ldagger/hilt/android/internal/managers/f;
...
.method protected n0()V
    ...
    iget-boolean v0, p0, Lso/x;->I:Z

    if-nez v0, :cond_0

    const/4 v0, 0x1

    iput-boolean v0, p0, Lso/x;->I:Z

    invoke-virtual {p0}, Lso/x;->t()Ljava/lang/Object;
    ...
    invoke-interface {v0, v1}, Lso/j;->t(Lso/i;)V
...
.method public final t()Ljava/lang/Object;
    ...
    invoke-virtual {p0}, Lso/x;->k0()Ldagger/hilt/android/internal/managers/f;
