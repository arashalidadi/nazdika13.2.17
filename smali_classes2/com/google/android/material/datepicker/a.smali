...
.field private final f:Lhf/k;


# direct methods
.method private constructor <init>(Landroid/content/res/ColorStateList;Landroid/content/res/ColorStateList;Landroid/content/res/ColorStateList;ILhf/k;Landroid/graphics/Rect;)V
    .locals 1
    ...
    iput-object p5, p0, Lcom/google/android/material/datepicker/a;->f:Lhf/k;
...
.method static a(Landroid/content/Context;I)Lcom/google/android/material/datepicker/a;
    ...
    invoke-static {p0, p1, v1}, Lef/c;->a(Landroid/content/Context;Landroid/content/res/TypedArray;I)Landroid/content/res/ColorStateList;
    ...
    invoke-static {p0, v1, v0}, Lhf/k;->b(Landroid/content/Context;II)Lhf/k$b;

    move-result-object p0

    invoke-virtual {p0}, Lhf/k$b;->m()Lhf/k;
    ...
    invoke-direct/range {v5 .. v11}, Lcom/google/android/material/datepicker/a;-><init>(Landroid/content/res/ColorStateList;Landroid/content/res/ColorStateList;Landroid/content/res/ColorStateList;ILhf/k;Landroid/graphics/Rect;)V
...
.method d(Landroid/widget/TextView;)V
    ...
    iget-object v2, p0, Lcom/google/android/material/datepicker/a;->f:Lhf/k;

    invoke-virtual {v0, v2}, Lhf/g;->setShapeAppearanceModel(Lhf/k;)V

    iget-object v2, p0, Lcom/google/android/material/datepicker/a;->f:Lhf/k;

    invoke-virtual {v1, v2}, Lhf/g;->setShapeAppearanceModel(Lhf/k;)V

    iget-object v2, p0, Lcom/google/android/material/datepicker/a;->c:Landroid/content/res/ColorStateList;

    invoke-virtual {v0, v2}, Lhf/g;->Y(Landroid/content/res/ColorStateList;)V
    ...
    invoke-static {p1, v0}, Landroidx/core/view/d1;->C0(Landroid/view/View;Landroid/graphics/drawable/Drawable;)V
