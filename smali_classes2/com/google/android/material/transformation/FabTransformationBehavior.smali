...
.method private L(Landroid/view/View;Lcom/google/android/material/transformation/FabTransformationBehavior$e;Loe/i;Loe/i;FFFFLandroid/graphics/RectF;)V
    .locals 0

    invoke-direct {p0, p2, p3, p5, p7}, Lcom/google/android/material/transformation/FabTransformationBehavior;->S(Lcom/google/android/material/transformation/FabTransformationBehavior$e;Loe/i;FF)F

    move-result p3

    invoke-direct {p0, p2, p4, p6, p8}, Lcom/google/android/material/transformation/FabTransformationBehavior;->S(Lcom/google/android/material/transformation/FabTransformationBehavior$e;Loe/i;FF)F
...
.method private N(FFZLcom/google/android/material/transformation/FabTransformationBehavior$e;)Landroid/util/Pair;
    ...
    :cond_2
    iget-object p1, p4, Lcom/google/android/material/transformation/FabTransformationBehavior$e;->a:Loe/h;

    const-string p2, "translationXCurveUpwards"

    invoke-virtual {p1, p2}, Loe/h;->e(Ljava/lang/String;)Loe/i;

    move-result-object p1

    iget-object p2, p4, Lcom/google/android/material/transformation/FabTransformationBehavior$e;->a:Loe/h;

    const-string p3, "translationYCurveUpwards"

    invoke-virtual {p2, p3}, Loe/h;->e(Ljava/lang/String;)Loe/i;
...
.method private O(Landroid/view/View;Landroid/view/View;Loe/j;)F
    .locals 2
    ...
    invoke-direct {p0, p1, p2, p3}, Lcom/google/android/material/transformation/FabTransformationBehavior;->Q(Landroid/view/View;Landroid/view/View;Loe/j;)F
...
.method private P(Landroid/view/View;Landroid/view/View;Loe/j;)F
    .locals 2
    ...
    invoke-direct {p0, p1, p2, p3}, Lcom/google/android/material/transformation/FabTransformationBehavior;->R(Landroid/view/View;Landroid/view/View;Loe/j;)F
...
.method private Q(Landroid/view/View;Landroid/view/View;Loe/j;)F
    .locals 2
...
.method private R(Landroid/view/View;Landroid/view/View;Loe/j;)F
    .locals 2
...
.method private S(Lcom/google/android/material/transformation/FabTransformationBehavior$e;Loe/i;FF)F
    .locals 8

    invoke-virtual {p2}, Loe/i;->c()J

    move-result-wide v0

    invoke-virtual {p2}, Loe/i;->d()J

    move-result-wide v2

    iget-object p1, p1, Lcom/google/android/material/transformation/FabTransformationBehavior$e;->a:Loe/h;

    const-string v4, "expansion"

    invoke-virtual {p1, v4}, Loe/h;->e(Ljava/lang/String;)Loe/i;

    move-result-object p1

    invoke-virtual {p1}, Loe/i;->c()J

    move-result-wide v4

    invoke-virtual {p1}, Loe/i;->d()J
    ...
    invoke-virtual {p2}, Loe/i;->e()Landroid/animation/TimeInterpolator;
    ...
    invoke-static {p3, p4, p1}, Loe/a;->a(FFF)F
...
.method private U(Landroid/view/View;Landroid/view/View;ZZLcom/google/android/material/transformation/FabTransformationBehavior$e;Ljava/util/List;Ljava/util/List;)V
    ...
    sget-object p3, Loe/d;->a:Landroid/util/Property;
    ...
    :cond_3
    sget-object p2, Loe/d;->a:Landroid/util/Property;
    ...
    :goto_0
    iget-object p2, p5, Lcom/google/android/material/transformation/FabTransformationBehavior$e;->a:Loe/h;
    ...
    invoke-virtual {p2, p1}, Loe/i;->a(Landroid/animation/Animator;)V
...
.method private V(Landroid/view/View;Landroid/view/View;ZZLcom/google/android/material/transformation/FabTransformationBehavior$e;Ljava/util/List;Ljava/util/List;)V
    ...
    invoke-interface {p2, p1}, Lte/d;->setCircularRevealScrimColor(I)V

    :cond_1
    sget-object p1, Lte/d$d;->a:Landroid/util/Property;
    ...
    :cond_2
    sget-object p3, Lte/d$d;->a:Landroid/util/Property;
...
.method private W(Landroid/view/View;Landroid/view/View;ZLcom/google/android/material/transformation/FabTransformationBehavior$e;Ljava/util/List;)V
    ...
    iget-object v0, p4, Lcom/google/android/material/transformation/FabTransformationBehavior$e;->b:Loe/j;

    invoke-direct {p0, p1, p2, v0}, Lcom/google/android/material/transformation/FabTransformationBehavior;->Q(Landroid/view/View;Landroid/view/View;Loe/j;)F

    move-result v0

    iget-object v1, p4, Lcom/google/android/material/transformation/FabTransformationBehavior$e;->b:Loe/j;

    invoke-direct {p0, p1, p2, v1}, Lcom/google/android/material/transformation/FabTransformationBehavior;->R(Landroid/view/View;Landroid/view/View;Loe/j;)F
    ...
    invoke-virtual {v1, v0}, Loe/i;->a(Landroid/animation/Animator;)V

    invoke-virtual {p4, p1}, Loe/i;->a(Landroid/animation/Animator;)V
...
.method private X(Landroid/view/View;Landroid/view/View;ZZLcom/google/android/material/transformation/FabTransformationBehavior$e;Ljava/util/List;Ljava/util/List;)V
    ...
    invoke-static {p1}, Landroidx/core/view/d1;->A(Landroid/view/View;)F
...
.method private Y(Landroid/view/View;Landroid/view/View;ZZLcom/google/android/material/transformation/FabTransformationBehavior$e;FFLjava/util/List;Ljava/util/List;)V
    ...
    check-cast v13, Lte/d;

    iget-object v1, v9, Lcom/google/android/material/transformation/FabTransformationBehavior$e;->b:Loe/j;

    invoke-direct {v12, v0, v8, v1}, Lcom/google/android/material/transformation/FabTransformationBehavior;->O(Landroid/view/View;Landroid/view/View;Loe/j;)F

    move-result v1

    iget-object v2, v9, Lcom/google/android/material/transformation/FabTransformationBehavior$e;->b:Loe/j;

    invoke-direct {v12, v0, v8, v2}, Lcom/google/android/material/transformation/FabTransformationBehavior;->P(Landroid/view/View;Landroid/view/View;Loe/j;)F
    ...
    iget-object v0, v9, Lcom/google/android/material/transformation/FabTransformationBehavior$e;->a:Loe/h;

    const-string v2, "expansion"

    invoke-virtual {v0, v2}, Loe/h;->e(Ljava/lang/String;)Loe/i;
    ...
    invoke-direct {v0, v1, v10, v11}, Lte/d$e;-><init>(FFF)V

    invoke-interface {v13, v0}, Lte/d;->setRevealInfo(Lte/d$e;)V

    :cond_1
    if-eqz p4, :cond_2

    invoke-interface {v13}, Lte/d;->getRevealInfo()Lte/d$e;

    move-result-object v0

    iget v0, v0, Lte/d$e;->c:F
    ...
    invoke-static/range {v2 .. v7}, Laf/a;->b(FFFFFF)F

    move-result v0

    invoke-static {v13, v1, v10, v0}, Lte/a;->a(Lte/d;FFF)Landroid/animation/Animator;

    move-result-object v9

    new-instance v0, Lcom/google/android/material/transformation/FabTransformationBehavior$d;

    invoke-direct {v0, v12, v13}, Lcom/google/android/material/transformation/FabTransformationBehavior$d;-><init>(Lcom/google/android/material/transformation/FabTransformationBehavior;Lte/d;)V

    invoke-virtual {v9, v0}, Landroid/animation/Animator;->addListener(Landroid/animation/Animator$AnimatorListener;)V

    invoke-virtual {v14}, Loe/i;->c()J
    ...
    iget v6, v0, Lte/d$e;->c:F

    invoke-static {v13, v1, v10, v11}, Lte/a;->a(Lte/d;FFF)Landroid/animation/Animator;
    ...
    invoke-virtual {v14}, Loe/i;->d()J

    move-result-wide v4

    iget-object v0, v9, Lcom/google/android/material/transformation/FabTransformationBehavior$e;->a:Loe/h;

    invoke-virtual {v0}, Loe/h;->f()J
    ...
    :goto_0
    invoke-virtual {v14, v9}, Loe/i;->a(Landroid/animation/Animator;)V

    move-object/from16 v0, p8

    invoke-interface {v0, v9}, Ljava/util/List;->add(Ljava/lang/Object;)Z

    invoke-static {v13}, Lte/a;->b(Lte/d;)Landroid/animation/Animator$AnimatorListener;
...
.method private Z(Landroid/view/View;Landroid/view/View;ZZLcom/google/android/material/transformation/FabTransformationBehavior$e;Ljava/util/List;Ljava/util/List;)V
    ...
    :cond_2
    sget-object p3, Loe/e;->b:Landroid/util/Property;
    ...
    invoke-virtual {p2, p4}, Loe/h;->e(Ljava/lang/String;)Loe/i;

    move-result-object p2

    invoke-virtual {p2, p3}, Loe/i;->a(Landroid/animation/Animator;)V

    invoke-interface {p6, p3}, Ljava/util/List;->add(Ljava/lang/Object;)Z

    new-instance p2, Lcom/google/android/material/transformation/FabTransformationBehavior$c;

    invoke-direct {p2, p0, v0, p1}, Lcom/google/android/material/transformation/FabTransformationBehavior$c;-><init>(Lcom/google/android/material/transformation/FabTransformationBehavior;Lte/d;Landroid/graphics/drawable/Drawable;)V
...
.method private c0(Landroid/view/View;Landroid/view/View;ZZLcom/google/android/material/transformation/FabTransformationBehavior$e;Ljava/util/List;Ljava/util/List;Landroid/graphics/RectF;)V
    ...
    iget-object v4, v3, Lcom/google/android/material/transformation/FabTransformationBehavior$e;->b:Loe/j;

    invoke-direct {v10, v0, v1, v4}, Lcom/google/android/material/transformation/FabTransformationBehavior;->Q(Landroid/view/View;Landroid/view/View;Loe/j;)F

    move-result v4

    iget-object v5, v3, Lcom/google/android/material/transformation/FabTransformationBehavior$e;->b:Loe/j;

    invoke-direct {v10, v0, v1, v5}, Lcom/google/android/material/transformation/FabTransformationBehavior;->R(Landroid/view/View;Landroid/view/View;Loe/j;)F
    ...
    check-cast v12, Loe/i;

    iget-object v5, v5, Landroid/util/Pair;->second:Ljava/lang/Object;

    move-object v13, v5

    check-cast v13, Loe/i;
    ...
    invoke-direct/range {v0 .. v9}, Lcom/google/android/material/transformation/FabTransformationBehavior;->L(Landroid/view/View;Lcom/google/android/material/transformation/FabTransformationBehavior$e;Loe/i;Loe/i;FFFFLandroid/graphics/RectF;)V
    ...
    :goto_0
    invoke-virtual {v12, v14}, Loe/i;->a(Landroid/animation/Animator;)V

    invoke-virtual {v13, v15}, Loe/i;->a(Landroid/animation/Animator;)V
...
.method protected J(Landroid/view/View;Landroid/view/View;ZZ)Landroid/animation/AnimatorSet;
    ...
    invoke-static {v0, v13}, Loe/b;->a(Landroid/animation/AnimatorSet;Ljava/util/List;)V
