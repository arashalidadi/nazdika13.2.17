...
.field private D:Lef/a;

.field private E:Lef/a;
...
.method private static G(FFFLandroid/animation/TimeInterpolator;)F
    ...
    :cond_0
    invoke-static {p0, p1, p2}, Loe/a;->a(FFF)F
...
.method private T(Landroid/graphics/Typeface;)Z
    ...
    iget-object v0, p0, Lcom/google/android/material/internal/a;->E:Lef/a;

    if-eqz v0, :cond_0

    invoke-virtual {v0}, Lef/a;->c()V
    ...
    invoke-static {v0, p1}, Lef/h;->b(Landroid/content/res/Configuration;Landroid/graphics/Typeface;)Landroid/graphics/Typeface;
...
.method private b0(Landroid/graphics/Typeface;)Z
    ...
    iget-object v0, p0, Lcom/google/android/material/internal/a;->D:Lef/a;
...
.method private d(F)F
    ...
    invoke-static {v2, v1, v3, v0, p1}, Loe/a;->b(FFFFF)F
    ...
    :cond_0
    invoke-static {v1, v2, v0, v2, p1}, Loe/a;->b(FFFFF)F
...
.method private k(IFZ)Landroid/text/StaticLayout;
    ...
    invoke-static {v2, v3, p2}, Lcom/google/android/material/internal/i;->c(Ljava/lang/CharSequence;Landroid/text/TextPaint;I)Lcom/google/android/material/internal/i;

    move-result-object p2

    iget-object v2, p0, Lcom/google/android/material/internal/a;->F:Landroid/text/TextUtils$TruncateAt;

    invoke-virtual {p2, v2}, Lcom/google/android/material/internal/i;->e(Landroid/text/TextUtils$TruncateAt;)Lcom/google/android/material/internal/i;

    move-result-object p2

    invoke-virtual {p2, p3}, Lcom/google/android/material/internal/i;->h(Z)Lcom/google/android/material/internal/i;

    move-result-object p2

    invoke-virtual {p2, v0}, Lcom/google/android/material/internal/i;->d(Landroid/text/Layout$Alignment;)Lcom/google/android/material/internal/i;
    ...
    invoke-virtual {p2, p1}, Lcom/google/android/material/internal/i;->j(I)Lcom/google/android/material/internal/i;
    ...
    invoke-virtual {p1, p2, p3}, Lcom/google/android/material/internal/i;->i(FF)Lcom/google/android/material/internal/i;

    move-result-object p1

    iget p2, p0, Lcom/google/android/material/internal/a;->s0:I

    invoke-virtual {p1, p2}, Lcom/google/android/material/internal/i;->f(I)Lcom/google/android/material/internal/i;

    move-result-object p1

    invoke-virtual {p1, v1}, Lcom/google/android/material/internal/i;->k(Lcom/google/android/material/internal/j;)Lcom/google/android/material/internal/i;
...
.method private m(Landroid/graphics/Canvas;FF)V
    ...
    invoke-static {v9, v10}, Lve/a;->a(II)I
    ...
    invoke-static {v8, v9}, Lve/a;->a(II)I
...
.method public H(Landroid/content/res/Configuration;)V
    ...
    invoke-static {p1, v0}, Lef/h;->b(Landroid/content/res/Configuration;Landroid/graphics/Typeface;)Landroid/graphics/Typeface;
...
.method public O(I)V
    ...
    invoke-virtual {v0}, Lef/d;->i()Landroid/content/res/ColorStateList;
    ...
    :cond_1
    iget-object p1, v0, Lef/d;->c:Landroid/content/res/ColorStateList;
    ...
    invoke-virtual {v0}, Lef/d;->e()Landroid/graphics/Typeface;

    move-result-object v2

    invoke-direct {p1, v1, v2}, Lef/a;-><init>(Lef/a$a;Landroid/graphics/Typeface;)V

    iput-object p1, p0, Lcom/google/android/material/internal/a;->E:Lef/a;
    ...
    iget-object v1, p0, Lcom/google/android/material/internal/a;->E:Lef/a;

    invoke-virtual {v0, p1, v1}, Lef/d;->h(Landroid/content/Context;Lef/f;)V
...
.method public c0(F)V
    ...
    invoke-static {p1, v0, v1}, Ls2/a;->a(FFF)F
