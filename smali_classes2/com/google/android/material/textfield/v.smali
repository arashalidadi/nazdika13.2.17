...
# instance fields
.field private final h:Landroidx/appcompat/widget/z1;
...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;I)V
    ...
    iput-object p1, p0, Lcom/google/android/material/textfield/v;->j:Landroid/graphics/Rect;

    invoke-virtual {p0}, Landroid/view/View;->getContext()Landroid/content/Context;

    move-result-object p1

    sget-object v3, Lne/m;->L2:[I
    ...
    iput p3, p0, Lcom/google/android/material/textfield/v;->l:F
    ...
    iput p3, p0, Lcom/google/android/material/textfield/v;->m:I
    ...
    iput-object p3, p0, Lcom/google/android/material/textfield/v;->n:Landroid/content/res/ColorStateList;
    ...
    iput-object p3, p0, Lcom/google/android/material/textfield/v;->i:Landroid/view/accessibility/AccessibilityManager;

    new-instance p3, Landroidx/appcompat/widget/z1;

    invoke-direct {p3, p1}, Landroidx/appcompat/widget/z1;-><init>(Landroid/content/Context;)V

    iput-object p3, p0, Lcom/google/android/material/textfield/v;->h:Landroidx/appcompat/widget/z1;

    const/4 p1, 0x1

    invoke-virtual {p3, p1}, Landroidx/appcompat/widget/z1;->J(Z)V

    invoke-virtual {p3, p0}, Landroidx/appcompat/widget/z1;->D(Landroid/view/View;)V

    const/4 p1, 0x2

    invoke-virtual {p3, p1}, Landroidx/appcompat/widget/z1;->I(I)V

    invoke-virtual {p0}, Landroid/widget/AutoCompleteTextView;->getAdapter()Landroid/widget/ListAdapter;

    move-result-object p1

    invoke-virtual {p3, p1}, Landroidx/appcompat/widget/z1;->p(Landroid/widget/ListAdapter;)V
    ...
    invoke-virtual {p3, p1}, Landroidx/appcompat/widget/z1;->L(Landroid/widget/AdapterView$OnItemClickListener;)V
...
.method static synthetic b(Lcom/google/android/material/textfield/v;)Landroidx/appcompat/widget/z1;
    .locals 0

    iget-object p0, p0, Lcom/google/android/material/textfield/v;->h:Landroidx/appcompat/widget/z1;
...
.method static synthetic d(Lcom/google/android/material/textfield/v;)I
    ...
    iget p0, p0, Lcom/google/android/material/textfield/v;->m:I
...
.method static synthetic e(Lcom/google/android/material/textfield/v;)Landroid/content/res/ColorStateList;
    ...
    iget-object p0, p0, Lcom/google/android/material/textfield/v;->n:Landroid/content/res/ColorStateList;
...
.method private g()I
    ...
    iget-object v5, p0, Lcom/google/android/material/textfield/v;->h:Landroidx/appcompat/widget/z1;

    invoke-virtual {v5}, Landroidx/appcompat/widget/z1;->x()I
    ...
    :cond_3
    iget-object v0, p0, Lcom/google/android/material/textfield/v;->h:Landroidx/appcompat/widget/z1;

    invoke-virtual {v0}, Landroidx/appcompat/widget/z1;->i()Landroid/graphics/drawable/Drawable;

    move-result-object v0

    if-eqz v0, :cond_4

    iget-object v2, p0, Lcom/google/android/material/textfield/v;->j:Landroid/graphics/Rect;

    invoke-virtual {v0, v2}, Landroid/graphics/drawable/Drawable;->getPadding(Landroid/graphics/Rect;)Z

    iget-object v0, p0, Lcom/google/android/material/textfield/v;->j:Landroid/graphics/Rect;
...
.method public getPopupElevation()F
    ...
    iget v0, p0, Lcom/google/android/material/textfield/v;->l:F
...
.method public getSimpleItemSelectedRippleColor()Landroid/content/res/ColorStateList;
    ...
    iget-object v0, p0, Lcom/google/android/material/textfield/v;->n:Landroid/content/res/ColorStateList;
...
.method public setAdapter(Landroid/widget/ListAdapter;)V
    ...
    iget-object p1, p0, Lcom/google/android/material/textfield/v;->h:Landroidx/appcompat/widget/z1;

    invoke-virtual {p0}, Landroid/widget/AutoCompleteTextView;->getAdapter()Landroid/widget/ListAdapter;

    move-result-object v0

    invoke-virtual {p1, v0}, Landroidx/appcompat/widget/z1;->p(Landroid/widget/ListAdapter;)V
...
.method public setOnItemSelectedListener(Landroid/widget/AdapterView$OnItemSelectedListener;)V
    ...
    invoke-virtual {p1, v0}, Landroidx/appcompat/widget/z1;->M(Landroid/widget/AdapterView$OnItemSelectedListener;)V
...
.method public setSimpleItemSelectedRippleColor(Landroid/content/res/ColorStateList;)V
    ...
    iput-object p1, p0, Lcom/google/android/material/textfield/v;->n:Landroid/content/res/ColorStateList;
...
.method public setSimpleItems([Ljava/lang/String;)V
    ...
    iget v2, p0, Lcom/google/android/material/textfield/v;->k:I
...
.method public showDropDown()V
    ...
    iget-object v0, p0, Lcom/google/android/material/textfield/v;->i:Landroid/view/accessibility/AccessibilityManager;
