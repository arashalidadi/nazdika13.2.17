...
.field private f:Ljd/m;

.field private final g:Ljava/util/concurrent/atomic/AtomicReference;

.field private h:Ljd/l;
...
.method protected constructor <init>(Ljd/f;)V
    .locals 2
    ...
    invoke-virtual {p1}, Ljd/f;->c()Landroid/os/Looper;
...
.method private final g()Ljd/l;
    ...
    invoke-static {v1, v3}, Lld/i;->n(ZLjava/lang/Object;)V
    ...
    iget-object v1, p0, Lcom/google/android/gms/common/api/internal/BasePendingResult;->h:Ljd/l;

    const/4 v3, 0x0

    iput-object v3, p0, Lcom/google/android/gms/common/api/internal/BasePendingResult;->h:Ljd/l;

    iput-object v3, p0, Lcom/google/android/gms/common/api/internal/BasePendingResult;->f:Ljd/m;
...
.method private final h(Ljd/l;)V
    .locals 4

    iput-object p1, p0, Lcom/google/android/gms/common/api/internal/BasePendingResult;->h:Ljd/l;

    invoke-interface {p1}, Ljd/l;->d()Lcom/google/android/gms/common/api/Status;
    ...
    iput-object p1, p0, Lcom/google/android/gms/common/api/internal/BasePendingResult;->m:Lld/d;
    ...
    iput-object p1, p0, Lcom/google/android/gms/common/api/internal/BasePendingResult;->f:Ljd/m;

    goto :goto_0

    :cond_0
    iget-object v0, p0, Lcom/google/android/gms/common/api/internal/BasePendingResult;->f:Ljd/m;

    if-nez v0, :cond_1

    iget-object v0, p0, Lcom/google/android/gms/common/api/internal/BasePendingResult;->h:Ljd/l;

    instance-of v0, v0, Ljd/i;

    if-eqz v0, :cond_2

    new-instance v0, Lcom/google/android/gms/common/api/internal/p0;

    invoke-direct {v0, p0, p1}, Lcom/google/android/gms/common/api/internal/p0;-><init>(Lcom/google/android/gms/common/api/internal/BasePendingResult;Lkd/h0;)V
    ...
    invoke-direct {p0}, Lcom/google/android/gms/common/api/internal/BasePendingResult;->g()Ljd/l;

    move-result-object v1

    invoke-virtual {p1, v0, v1}, Lcom/google/android/gms/common/api/internal/BasePendingResult$a;->a(Ljd/m;Ljd/l;)V
    ...
    invoke-interface {v2, v3}, Ljd/g$a;->a(Lcom/google/android/gms/common/api/Status;)V
...
.method static bridge synthetic i(Lcom/google/android/gms/common/api/internal/BasePendingResult;)Ljd/l;
    .locals 0

    iget-object p0, p0, Lcom/google/android/gms/common/api/internal/BasePendingResult;->h:Ljd/l;

    return-object p0
.end method

.method public static k(Ljd/l;)V
    .locals 2

    instance-of v0, p0, Ljd/i;
    ...
    invoke-interface {v0}, Ljd/i;->release()V
    :try_end_0
...
# virtual methods
.method public final a(Ljd/g$a;)V
    .locals 2
    ...
    invoke-interface {p1, v1}, Ljd/g$a;->a(Lcom/google/android/gms/common/api/Status;)V
...
.method public final b(JLjava/util/concurrent/TimeUnit;)Ljd/l;
    .locals 3
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(J",
    ...
    invoke-static {v0}, Lld/i;->i(Ljava/lang/String;)V
    ...
    invoke-static {v0, v2}, Lld/i;->n(ZLjava/lang/Object;)V

    const-string v0, "Cannot await if then() has been called."

    invoke-static {v1, v0}, Lld/i;->n(ZLjava/lang/Object;)V
    ...
    invoke-static {p1, p2}, Lld/i;->n(ZLjava/lang/Object;)V
...
.method protected abstract c(Lcom/google/android/gms/common/api/Status;)Ljd/l;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
...
.method public final f(Ljd/l;)V
    ...
    invoke-static {v1, v2}, Lld/i;->n(ZLjava/lang/Object;)V
    ...
    invoke-direct {p0, p1}, Lcom/google/android/gms/common/api/internal/BasePendingResult;->h(Ljd/l;)V
    ...
    :cond_0
    invoke-static {p1}, Lcom/google/android/gms/common/api/internal/BasePendingResult;->k(Ljd/l;)V
