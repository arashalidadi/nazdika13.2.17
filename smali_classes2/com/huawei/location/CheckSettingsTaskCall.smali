...
.method private changeResponse(Luj/a;)Lcom/huawei/location/resp/CheckLocationSettingsResp;
    .locals 3
    ...
    invoke-virtual {p1}, Luj/a;->a()Lcom/huawei/hms/support/api/client/Status;
    ...
    invoke-virtual {p1}, Luj/a;->b()Lcom/huawei/hms/location/LocationSettingsStates;
...
.method public onRequest(Ljava/lang/String;)V
    ...
    invoke-static {v1}, Lci/c;->r(Ljava/lang/String;)Z

    move-result v1

    const-string v2, "network"

    invoke-static {v2}, Lci/c;->r(Ljava/lang/String;)Z
    ...
    invoke-static {v2}, Lij/i;->d(Landroid/content/Context;)Z
    ...
    invoke-static {v2}, Lij/i;->b(Landroid/content/Context;)Z
    ...
    invoke-static {v2}, Lij/i;->f(Landroid/content/Context;)Z
    ...
    invoke-static {v2}, Lij/i;->c(Landroid/content/Context;)Z
    ...
    invoke-direct {v2}, Luj/a;-><init>()V

    sget-object v3, Lcom/huawei/hms/support/api/client/Status;->SUCCESS:Lcom/huawei/hms/support/api/client/Status;

    invoke-virtual {v2, v3}, Luj/a;->d(Lcom/huawei/hms/support/api/client/Status;)V

    invoke-virtual {v2, p1}, Luj/a;->c(Lcom/huawei/hms/location/LocationSettingsStates;)V
    ...
    invoke-direct {p0, v2}, Lcom/huawei/location/CheckSettingsTaskCall;->changeResponse(Luj/a;)Lcom/huawei/location/resp/CheckLocationSettingsResp;
