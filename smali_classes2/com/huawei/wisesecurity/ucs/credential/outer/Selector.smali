...
.method public static selectGrsCapability(Lcom/huawei/wisesecurity/ucs/credential/outer/GrsCapability;Landroid/content/Context;Ljava/lang/String;)Lul/r;
    .locals 2
    ...
    new-instance p1, Lul/g0;

    invoke-direct {p1, p0}, Lul/g0;-><init>(Lcom/huawei/wisesecurity/ucs/credential/outer/GrsCapability;)V
    ...
    invoke-direct {p0, p1, p2}, Lul/s;-><init>(Landroid/content/Context;Ljava/lang/String;)V
    :try_end_0
...
.method public static selectHACapability(Lcom/huawei/wisesecurity/ucs/credential/outer/HACapability;Lul/r;Lcom/huawei/wisesecurity/ucs/common/report/ReportOption;)Lcom/huawei/wisesecurity/ucs/credential/outer/HACapability;
    .locals 2
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Lcom/huawei/wisesecurity/ucs/common/exception/UcsException;
    ...
    invoke-direct {p0, p1, p2}, Lul/g;-><init>(Lul/r;Lcom/huawei/wisesecurity/ucs/common/report/ReportOption;)V
    :try_end_0
    .catch Ljava/lang/ClassNotFoundException; {:try_start_0 .. :try_end_0} :catch_0
...
.method public static selectNetWorkCapability(Lcom/huawei/wisesecurity/ucs/credential/outer/NetworkCapability;Landroid/content/Context;II)Lcom/huawei/wisesecurity/ucs/credential/outer/NetworkCapability;
    ...
    invoke-direct {p0, p1}, Lul/c;-><init>(Landroid/content/Context;)V

    invoke-virtual {p0, p2, p3}, Lul/c;->initConfig(II)V
