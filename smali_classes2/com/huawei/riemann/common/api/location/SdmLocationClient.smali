...
.field public mSdmLocManager:Lmk/a;
...
.method public constructor <init>(Landroid/content/Context;Landroid/content/Intent;Ljava/lang/String;)V
    ...
    invoke-direct {v0, p1, p2, p3}, Lmk/a;-><init>(Landroid/content/Context;Landroid/content/Intent;Ljava/lang/String;)V

    iput-object v0, p0, Lcom/huawei/riemann/common/api/location/SdmLocationClient;->mSdmLocManager:Lmk/a;
...
.method public constructor <init>(Landroid/content/Context;Landroid/os/Looper;Ljava/lang/String;)V
    ...
    invoke-direct {v0, p1, p2, p3}, Lmk/a;-><init>(Landroid/content/Context;Landroid/os/Looper;Ljava/lang/String;)V
...
.method public constructor <init>(Landroid/content/Context;Ljava/lang/String;)V
    ...
    invoke-direct {v0, p1, p2}, Lmk/a;-><init>(Landroid/content/Context;Ljava/lang/String;)V
...
.method public process(Lcom/huawei/riemann/location/bean/obs/Pvt;[Lcom/huawei/riemann/location/bean/obs/GnssRawObservation;)Lcom/huawei/riemann/location/bean/obs/Pvt;
    ...
    iget-object v0, p0, Lcom/huawei/riemann/common/api/location/SdmLocationClient;->mSdmLocManager:Lmk/a;
    ...
    :cond_1
    iget-object v1, v0, Lmk/a;->l:Lcom/huawei/riemann/location/SdmLocationAlgoWrapper;

    if-eqz v1, :cond_3

    iget-boolean v1, v1, Lcom/huawei/riemann/location/SdmLocationAlgoWrapper;->a:Z
    ...
    :cond_2
    iget-object p2, v0, Lmk/a;->l:Lcom/huawei/riemann/location/SdmLocationAlgoWrapper;
    ...
    iget-object p2, v0, Lmk/a;->h:Lmk/a$c;
...
.method public startLocation(Lcom/huawei/riemann/location/bean/DeviceInfo;Lcom/huawei/riemann/common/api/location/CityTileCallback;)I
    ...
    invoke-virtual {v0, v1}, Lmk/a;->a(Landroid/os/Looper;)V

    iget-object v1, v0, Lmk/a;->h:Lmk/a$c;

    if-eqz v1, :cond_0

    iput-object p2, v0, Lmk/a;->n:Lcom/huawei/riemann/common/api/location/CityTileCallback;

    new-instance v3, Lmk/a$d;

    invoke-direct {v3, v1, p2}, Lmk/a$d;-><init>(Landroid/os/Handler;Lcom/huawei/riemann/common/api/location/CityTileCallback;)V

    iput-object v3, v0, Lmk/a;->m:Lcom/huawei/riemann/common/api/location/CityTileCallback;

    goto :goto_0

    :cond_0
    new-instance v1, Lmk/a$d;
    ...
    invoke-direct {v1, v3, p2}, Lmk/a$d;-><init>(Landroid/os/Handler;Lcom/huawei/riemann/common/api/location/CityTileCallback;)V

    iput-object v1, v0, Lmk/a;->m:Lcom/huawei/riemann/common/api/location/CityTileCallback;
    ...
    iget-object v1, v0, Lmk/a;->m:Lcom/huawei/riemann/common/api/location/CityTileCallback;
...
.method public stopLocation()V
    ...
    iput-object v1, v0, Lmk/a;->n:Lcom/huawei/riemann/common/api/location/CityTileCallback;

    iput-object v1, v0, Lmk/a;->m:Lcom/huawei/riemann/common/api/location/CityTileCallback;

    iget-boolean v4, v0, Lmk/a;->k:Z

    if-eqz v4, :cond_4

    iget-object v4, v0, Lmk/a;->f:Lmk/a$e;
    ...
    :cond_1
    iget-object v4, v0, Lmk/a;->h:Lmk/a$c;
    ...
    :cond_2
    iget-object v4, v0, Lmk/a;->g:Lmk/a$b;
    ...
    :cond_3
    iput-object v1, v0, Lmk/a;->f:Lmk/a$e;

    iput-object v1, v0, Lmk/a;->h:Lmk/a$c;

    iput-object v1, v0, Lmk/a;->g:Lmk/a$b;

    :cond_4
    iput-boolean v2, v0, Lmk/a;->k:Z
