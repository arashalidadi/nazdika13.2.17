...
.method static synthetic access$000(Lcom/huawei/hms/common/HuaweiApi;Lcom/huawei/hms/common/HuaweiApi;Lzh/g;)V
    .locals 0

    invoke-direct {p0, p1, p2}, Lcom/huawei/hms/common/HuaweiApi;->innerDisconnect(Lcom/huawei/hms/common/HuaweiApi;Lzh/g;)V
...
.method private innerDisconnect(Lcom/huawei/hms/common/HuaweiApi;Lzh/g;)V
    .locals 3
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-virtual {p2, p1}, Lzh/g;->d(Ljava/lang/Object;)V
    :try_end_0
...
.method private sendRequest(Lcom/huawei/hms/common/internal/TaskApiCall;)Lzh/f;
    .locals 3
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "<TResult:",
    ...
    invoke-virtual {p1}, Lcom/huawei/hms/common/internal/TaskApiCall;->getToken()Lzh/a;
    ...
    invoke-direct {v0, v1}, Lzh/g;-><init>(Lzh/a;)V

    :goto_0
    new-instance v1, Lcom/huawei/hms/common/internal/TaskApiCallWrapper;

    invoke-direct {v1, p1, v0}, Lcom/huawei/hms/common/internal/TaskApiCallWrapper;-><init>(Lcom/huawei/hms/common/internal/TaskApiCall;Lzh/g;)V
...
# virtual methods
.method public disconnectService()Lzh/f;
    .locals 3
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "()",
    ...
    invoke-direct {v2, p0, p0, v0}, Lcom/huawei/hms/common/HuaweiApi$1;-><init>(Lcom/huawei/hms/common/HuaweiApi;Lcom/huawei/hms/common/HuaweiApi;Lzh/g;)V
...
.method public doWrite(Lcom/huawei/hms/common/internal/TaskApiCall;)Lzh/f;
    ...
    invoke-virtual {p1, v0}, Lzh/g;->c(Ljava/lang/Exception;)V

    invoke-virtual {p1}, Lzh/g;->b()Lzh/f;
    ...
    :cond_2
    invoke-direct {p0, p1}, Lcom/huawei/hms/common/HuaweiApi;->sendRequest(Lcom/huawei/hms/common/internal/TaskApiCall;)Lzh/f;
